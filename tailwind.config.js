...
module.exports = {
  ...
  theme: {
    extend: {
      // Modern Color Palette - Linear/Stripe inspired
      colors: {
        ...
        // Secondary/Accent: Vibrant Teal (Growth, Success)
        accent: {
          50: '#f0fdfa',
          100: '#ccfbf1',
          200: '#99f6e4',
        ...
        // Destructive: Soft Rose (Not jarring)
        destructive: {
          50: '#fff1f2',
          100: '#ffe4e6',
          200: '#fecdd3',
        ...
        // Neutrals: Slate scale (Blue-based grays, reduces eye strain)
        neutral: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
      ...
      // Custom Soft Shadows (Linear/Stripe style)
      boxShadow: {
